defmodule Test.OutputConverter do
  ...
  @output ~s({"type":"Issue","location":{"path":"web/test.ex","lines":{"end":1,"begin":1}},"description":"Modules should have a @moduledoc tag.","check_name":"Code Readability","categories":["Style"]})
